...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    */
    ...
    const singleLogo = (
      <img src='https://cdn.haitrieu.com/wp-content/uploads/2022/12/Logo-Dai-Hoc-Van-Lang-H.png' alt='Logo'/>
    );
    ...
    return (
      <Box
        ...
        href={href}
        className={logoClasses.root.concat(className ? ` ${className} logo-image` : '')}
        aria-label="Logo"
        sx={{
          ...baseSize,
          flexShrink: 0,
